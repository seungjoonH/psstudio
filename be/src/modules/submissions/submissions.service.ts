        ...
        messages: [
          {
            ...
            content: [
              ...
              "각 lineComment에 대해 출력 직전 다음 항목을 모두 점검한다. **하나라도 만족 못 하면 그 lineComment는 작성하지 않는다.**",
              ...
              "6. 지적한 코드가 오답의 직접 원인인가, 제안 수정이 반례를 해결하고 기존 정상 동작을 깨지 않는가? (위 \"원인 분석 검증\"·\"수정안 검증\"·\"최소 수정\"·\"원인↔반례 연결\"을 충족하는가?)",
              "",
              "── summary 규칙 ──",
